...
const AvatarSelectionScreen: React.FC = () => {
    ...
    const avatars: Avatar[] = [
        {
            id: 1,
            imageUrl: 'https://assets-taskly.s3.sa-east-1.amazonaws.com/Ellipse+1.png',
            borderColor: '#5B3CC4',
        },
        {
            id: 2,
            imageUrl: 'https://assets-taskly.s3.sa-east-1.amazonaws.com/Ellipse+2.png',
            borderColor: '#E6E0F7',
        },
        {
            id: 3,
            imageUrl: 'https://assets-taskly.s3.sa-east-1.amazonaws.com/Ellipse+3.png',
            borderColor: '#32C25B',
        },
        {
            id: 4,
            imageUrl: 'https://assets-taskly.s3.sa-east-1.amazonaws.com/Ellipse+4.png',
            borderColor: '#E63946',
        },
        {
            id: 5,
            imageUrl:'https://assets-taskly.s3.sa-east-1.amazonaws.com/Ellipse+5.png',
            borderColor: '#B58B46',
        },
    ];
